...
//         const url = API_URL + '/search?search=' + param.search; 
//         axios.get(url)
//             .then((res) => {
                    ...
                    {cproducts && cproducts.length > 0 &&
                        cproducts.map((item) => (
                            <div
                                ...
                                onClick={() => handleProduct(item._id)} // Navigate to product detail
                            >
                                <div
                                ...
                                <div style={{ padding: '10px' }}>
                                    <h3 style={{ color: 'red', marginBottom: '10px' }}>
                                        Rs. {item.price} /- {/* Product price */}
                                    </h3>
                                    <p style={{ marginBottom: '10px', fontWeight: 'bold' }}>
                                        {item.pname} | {item.category}
                                    </p>
                                    <p style={{ color: 'green' }}>
                                        {item.pdesc} {/* Product description */}
                                    </p>
                                </div>
                            </div>
                        ))}
                        ...
                        products.map((item) => (
                            <div
                                ...
                                style={{
                                    ...
                                    padding: '15px',
                                    borderRadius: '10px',
                                    boxShadow: '0 5px 15px rgba(0, 0, 0, 0.1)', // Shadow for depth
                                    cursor: 'pointer', // Indicate clickable
                                    backgroundColor: '#ffffff',
                                    transition: 'box-shadow 0.3s', // Smooth hover transition
                                }}
                                onClick={() => handleProduct(item._id)} // Click to navigate to product detail
                            >
                                <div
                                    onClick={() => handleLike(item._id)}
                                    style={{
                                        position: 'absolute', // Position heart icon in the corner
                                        top: '10px',
                                        right: '10px',
                                        color: 'red',
                                        cursor: 'pointer',
                                ...
                                <img
                                    ...
                                    style={{
                                        ...
                                        objectFit: 'cover', // Image fills the space
                                    }}
                                />
                                <div style={{ padding: '10px' }}>
                                    <h3 style={{ color: 'red', marginBottom: '10px' }}>
